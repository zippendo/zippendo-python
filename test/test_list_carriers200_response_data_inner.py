...
class TestListCarriers200ResponseDataInner(unittest.TestCase):
    """ListCarriers200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListCarriers200ResponseDataInner:
        """Test ListCarriers200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListCarriers200ResponseDataInner`
        """
        model = ListCarriers200ResponseDataInner()
        if include_optional:
    ...
    def testListCarriers200ResponseDataInner(self):
        """Test ListCarriers200ResponseDataInner"""
