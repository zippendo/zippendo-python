...
class TestUpdateShippingRuleRequest(unittest.TestCase):
    """UpdateShippingRuleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateShippingRuleRequest:
        """Test UpdateShippingRuleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateShippingRuleRequest`
        """
        model = UpdateShippingRuleRequest()
        if include_optional:
            return UpdateShippingRuleRequest(
                name = 'Standard DK',
    ...
    def testUpdateShippingRuleRequest(self):
        """Test UpdateShippingRuleRequest"""
