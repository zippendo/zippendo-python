...
class TestBatchSplitShipmentRequest(unittest.TestCase):
    """BatchSplitShipmentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchSplitShipmentRequest:
        """Test BatchSplitShipmentRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchSplitShipmentRequest`
        """
        model = BatchSplitShipmentRequest()
        if include_optional:
            return BatchSplitShipmentRequest(
                parcel_id = 'prc_5a6b7c8d',
                shipments = [
                    zippendo.models.batch_split_shipment_request_shipments_inner.batchSplitShipment_request_shipments_inner(
    ...
    def testBatchSplitShipmentRequest(self):
        """Test BatchSplitShipmentRequest"""
