...
class TestCreateOrderChannelRequest(unittest.TestCase):
    """CreateOrderChannelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrderChannelRequest:
        """Test CreateOrderChannelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrderChannelRequest`
        """
        model = CreateOrderChannelRequest()
        if include_optional:
            return CreateOrderChannelRequest(
                name = 'Anna's webshop',
                type = 'custom',
    ...
    def testCreateOrderChannelRequest(self):
        """Test CreateOrderChannelRequest"""
