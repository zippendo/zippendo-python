...
class TestGetBillingUsage200ResponseAddOnsInner(unittest.TestCase):
    """GetBillingUsage200ResponseAddOnsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBillingUsage200ResponseAddOnsInner:
        """Test GetBillingUsage200ResponseAddOnsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBillingUsage200ResponseAddOnsInner`
        """
        model = GetBillingUsage200ResponseAddOnsInner()
        if include_optional:
            return GetBillingUsage200ResponseAddOnsInner(
                type = 'extra_carrier',
                quantity = 2,
                unit_price = 9900,
                total_price = 19800
    ...
    def testGetBillingUsage200ResponseAddOnsInner(self):
        """Test GetBillingUsage200ResponseAddOnsInner"""
