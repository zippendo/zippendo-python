...
class TestCreateShipmentRequestPartiesInner(unittest.TestCase):
    """CreateShipmentRequestPartiesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateShipmentRequestPartiesInner:
        """Test CreateShipmentRequestPartiesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShipmentRequestPartiesInner`
        """
        model = CreateShipmentRequestPartiesInner()
        if include_optional:
            return CreateShipmentRequestPartiesInner(
                type = 'receiver',
                name = 'Anna Jensen',
                attention = 'Reception',
    ...
    def testCreateShipmentRequestPartiesInner(self):
        """Test CreateShipmentRequestPartiesInner"""
