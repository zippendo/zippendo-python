...
class TestConnectCarrierRequest(unittest.TestCase):
    """ConnectCarrierRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConnectCarrierRequest:
        """Test ConnectCarrierRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConnectCarrierRequest`
        """
        model = ConnectCarrierRequest()
        if include_optional:
    ...
    def testConnectCarrierRequest(self):
        """Test ConnectCarrierRequest"""
