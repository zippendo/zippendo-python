...
class TestUpdateShipmentRequestDroppoint(unittest.TestCase):
    """UpdateShipmentRequestDroppoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateShipmentRequestDroppoint:
        """Test UpdateShipmentRequestDroppoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateShipmentRequestDroppoint`
        """
        model = UpdateShipmentRequestDroppoint()
        if include_optional:
            return UpdateShipmentRequestDroppoint(
                id = 'sp_pn_4521',
                name = 'Føtex Nørrebro',
    ...
    def testUpdateShipmentRequestDroppoint(self):
        """Test UpdateShipmentRequestDroppoint"""
