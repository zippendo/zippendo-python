...
class TestCreateOrderChannelRequestSettingsShippingMethodMappingsInner(unittest.TestCase):
    """CreateOrderChannelRequestSettingsShippingMethodMappingsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrderChannelRequestSettingsShippingMethodMappingsInner:
        """Test CreateOrderChannelRequestSettingsShippingMethodMappingsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrderChannelRequestSettingsShippingMethodMappingsInner`
        """
        model = CreateOrderChannelRequestSettingsShippingMethodMappingsInner()
        if include_optional:
            return CreateOrderChannelRequestSettingsShippingMethodMappingsInner(
    ...
    def testCreateOrderChannelRequestSettingsShippingMethodMappingsInner(self):
        """Test CreateOrderChannelRequestSettingsShippingMethodMappingsInner"""
