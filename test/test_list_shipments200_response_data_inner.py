...
class TestListShipments200ResponseDataInner(unittest.TestCase):
    """ListShipments200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListShipments200ResponseDataInner:
        """Test ListShipments200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListShipments200ResponseDataInner`
        """
        model = ListShipments200ResponseDataInner()
        if include_optional:
            return ListShipments200ResponseDataInner(
                id = 'shp_4d9e7a2f',
    ...
    def testListShipments200ResponseDataInner(self):
        """Test ListShipments200ResponseDataInner"""
