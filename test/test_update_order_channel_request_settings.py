...
class TestUpdateOrderChannelRequestSettings(unittest.TestCase):
    """UpdateOrderChannelRequestSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrderChannelRequestSettings:
        """Test UpdateOrderChannelRequestSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrderChannelRequestSettings`
        """
        model = UpdateOrderChannelRequestSettings()
        if include_optional:
            return UpdateOrderChannelRequestSettings(
                use_webhooks = True,
    ...
    def testUpdateOrderChannelRequestSettings(self):
        """Test UpdateOrderChannelRequestSettings"""
