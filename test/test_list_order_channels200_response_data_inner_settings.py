...
class TestListOrderChannels200ResponseDataInnerSettings(unittest.TestCase):
    """ListOrderChannels200ResponseDataInnerSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOrderChannels200ResponseDataInnerSettings:
        """Test ListOrderChannels200ResponseDataInnerSettings
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOrderChannels200ResponseDataInnerSettings`
        """
        model = ListOrderChannels200ResponseDataInnerSettings()
        if include_optional:
            return ListOrderChannels200ResponseDataInnerSettings(
                use_webhooks = True,
    ...
    def testListOrderChannels200ResponseDataInnerSettings(self):
        """Test ListOrderChannels200ResponseDataInnerSettings"""
