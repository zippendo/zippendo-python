...
class TestCreateShippingRuleRequestConditionsInnerOneOf4(unittest.TestCase):
    """CreateShippingRuleRequestConditionsInnerOneOf4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateShippingRuleRequestConditionsInnerOneOf4:
        """Test CreateShippingRuleRequestConditionsInnerOneOf4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShippingRuleRequestConditionsInnerOneOf4`
        """
        model = CreateShippingRuleRequestConditionsInnerOneOf4()
        if include_optional:
            return CreateShippingRuleRequestConditionsInnerOneOf4(
                type = 'flatRate',
                shipping_price = 39,
                currency = 'DKK'
            )
    ...
    def testCreateShippingRuleRequestConditionsInnerOneOf4(self):
        """Test CreateShippingRuleRequestConditionsInnerOneOf4"""
