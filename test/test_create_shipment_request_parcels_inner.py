...
class TestCreateShipmentRequestParcelsInner(unittest.TestCase):
    """CreateShipmentRequestParcelsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateShipmentRequestParcelsInner:
        """Test CreateShipmentRequestParcelsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateShipmentRequestParcelsInner`
        """
        model = CreateShipmentRequestParcelsInner()
        if include_optional:
            return CreateShipmentRequestParcelsInner(
                id = 'prc_5a6b7c8d',
                weight = 2.5,
                weight_unit = 'kg',
    ...
    def testCreateShipmentRequestParcelsInner(self):
        """Test CreateShipmentRequestParcelsInner"""
