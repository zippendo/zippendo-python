...
class TestBatchSendShipmentsRequest(unittest.TestCase):
    """BatchSendShipmentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BatchSendShipmentsRequest:
        """Test BatchSendShipmentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BatchSendShipmentsRequest`
        """
        model = BatchSendShipmentsRequest()
        if include_optional:
            return BatchSendShipmentsRequest(
    ...
    def testBatchSendShipmentsRequest(self):
        """Test BatchSendShipmentsRequest"""
