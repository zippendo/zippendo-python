...
class TestUpdateOrderChannelRequest(unittest.TestCase):
    """UpdateOrderChannelRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrderChannelRequest:
        """Test UpdateOrderChannelRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrderChannelRequest`
        """
        model = UpdateOrderChannelRequest()
        if include_optional:
            return UpdateOrderChannelRequest(
                ...
                settings = zippendo.models.update_order_channel_request_settings.updateOrderChannel_request_settings(
                    use_webhooks = True, 
    ...
    def testUpdateOrderChannelRequest(self):
        """Test UpdateOrderChannelRequest"""
