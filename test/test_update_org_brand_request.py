...
class TestUpdateOrgBrandRequest(unittest.TestCase):
    """UpdateOrgBrandRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateOrgBrandRequest:
        """Test UpdateOrgBrandRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateOrgBrandRequest`
        """
        model = UpdateOrgBrandRequest()
        if include_optional:
            return UpdateOrgBrandRequest(
    ...
    def testUpdateOrgBrandRequest(self):
        """Test UpdateOrgBrandRequest"""
