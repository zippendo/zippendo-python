...
class TestGetOrder200ResponseOrderLinesInner(unittest.TestCase):
    """GetOrder200ResponseOrderLinesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrder200ResponseOrderLinesInner:
        """Test GetOrder200ResponseOrderLinesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrder200ResponseOrderLinesInner`
        """
        model = GetOrder200ResponseOrderLinesInner()
        if include_optional:
            return GetOrder200ResponseOrderLinesInner(
                sku = 'SKU-1042-BLK',
                name = 'Wool Sweater',
                quantity = 2,
                unit_price = 499,
    ...
    def testGetOrder200ResponseOrderLinesInner(self):
        """Test GetOrder200ResponseOrderLinesInner"""
