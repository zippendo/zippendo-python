...
class TestListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner(unittest.TestCase):
    """ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner:
        """Test ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner`
        """
        model = ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner()
        if include_optional:
            return ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner(
    ...
    def testListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner(self):
        """Test ListOrderChannels200ResponseDataInnerSettingsShippingMethodMappingsInner"""
