...
class TestCreateOrgWebhookRequest(unittest.TestCase):
    """CreateOrgWebhookRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrgWebhookRequest:
        """Test CreateOrgWebhookRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrgWebhookRequest`
        """
        model = CreateOrgWebhookRequest()
        if include_optional:
            return CreateOrgWebhookRequest(
    ...
    def testCreateOrgWebhookRequest(self):
        """Test CreateOrgWebhookRequest"""
