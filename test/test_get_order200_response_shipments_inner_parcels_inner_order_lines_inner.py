...
class TestGetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner(unittest.TestCase):
    """GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner:
        """Test GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner`
        """
        model = GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner()
        if include_optional:
            return GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner(
                id = 'ol_9c1d2e3f',
                sku = 'SKU-1042-BLK',
                quantity = 2,
    ...
    def testGetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner(self):
        """Test GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner"""
