...
class TestCreateOrgBrandRequest(unittest.TestCase):
    """CreateOrgBrandRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrgBrandRequest:
        """Test CreateOrgBrandRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrgBrandRequest`
        """
        model = CreateOrgBrandRequest()
        if include_optional:
            return CreateOrgBrandRequest(
    ...
    def testCreateOrgBrandRequest(self):
        """Test CreateOrgBrandRequest"""
