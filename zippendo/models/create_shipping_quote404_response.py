...
class CreateShippingQuote404Response(BaseModel):
    """
    CreateShippingQuote404Response
    """ # noqa: E501
    error: StrictStr = Field(description="Error type", json_schema_extra={"examples": ["Not Found"]})
    message: StrictStr = Field(description="Human-readable error message", json_schema_extra={"examples": ["Organization not found"]})
