...
class ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner(BaseModel):
    """
    ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner
    """ # noqa: E501
    name: StrictStr = Field(description="Display label for the option", json_schema_extra={"examples": ["Standard"]})
    key: StrictStr = Field(description="Machine key for the option", json_schema_extra={"examples": ["standard"]})
    value: StrictStr = Field(description="Value submitted when the option is selected", json_schema_extra={"examples": ["STD"]})
    __properties: ClassVar[List[str]] = ["name", "key", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCarrierProducts200ResponseInnerAdditionalParametersInnerOptionsInner from a dict"""
        if obj is None:
            return None
