...
class SplitShipmentParcelRequest(BaseModel):
    """
    SplitShipmentParcelRequest
    """ # noqa: E501
    parcels: Annotated[List[SplitShipmentParcelRequestParcelsInner], Field(min_length=1)] = Field(description="Target parcel layout to redistribute order lines into.")
    __properties: ClassVar[List[str]] = ["parcels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "parcels": [SplitShipmentParcelRequestParcelsInner.from_dict(_item) for _item in obj["parcels"]] if obj.get("parcels") is not None else None
        })
        return _obj
