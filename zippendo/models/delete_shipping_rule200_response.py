...
class DeleteShippingRule200Response(BaseModel):
    """
    DeleteShippingRule200Response
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the rule was deleted", json_schema_extra={"examples": [True]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteShippingRule200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteShippingRule200Response from a dict"""
        if obj is None:
            return None
