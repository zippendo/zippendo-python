...
class GetBillingUsage200ResponseLimitsTeamMembers(BaseModel):
    """
    GetBillingUsage200ResponseLimitsTeamMembers
    """ # noqa: E501
    used: Union[StrictFloat, StrictInt] = Field(description="Amount of the resource currently used", json_schema_extra={"examples": [3]})
    limit: Union[StrictFloat, StrictInt] = Field(description="Maximum allowed (-1 for unlimited)", json_schema_extra={"examples": [5]})
