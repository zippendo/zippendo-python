...
class ListApiTokens200ResponseDataInnerCreatedBy(BaseModel):
    """
    ListApiTokens200ResponseDataInnerCreatedBy
    """ # noqa: E501
    id: StrictStr = Field(description="Creator user identifier", json_schema_extra={"examples": ["usr_9f3kd92ld0"]})
    name: Optional[StrictStr] = Field(description="Creator full name", json_schema_extra={"examples": ["Anna Jensen"]})
    email: StrictStr = Field(description="Creator email address", json_schema_extra={"examples": ["anna@example.dk"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApiTokens200ResponseDataInnerCreatedBy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApiTokens200ResponseDataInnerCreatedBy from a dict"""
        if obj is None:
            return None
