...
class ListShippingRules200ResponseDataInnerConditionsInnerOneOf3(BaseModel):
    """
    ListShippingRules200ResponseDataInnerConditionsInnerOneOf3
    """ # noqa: E501
    type: StrictStr = Field(description="Condition type discriminator", json_schema_extra={"examples": ["quantity"]})
    operator: StrictStr = Field(description="Comparison operator", json_schema_extra={"examples": ["gte"]})
    value: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(description="Quantity value to compare against", json_schema_extra={"examples": [3]})
    ...
    __properties: ClassVar[List[str]] = ["type", "operator", "value", "shippingPrice", "currency"]
