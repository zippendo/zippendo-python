...
class HealthCheck200Response(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr = Field(description="Service status", json_schema_extra={"examples": ["ok"]})
    timestamp: StrictStr = Field(description="Current server time (ISO 8601)", json_schema_extra={"examples": ["2026-06-22T14:30:00.000Z"]})
    version: StrictStr = Field(description="API version", json_schema_extra={"examples": ["1.0.0"]})
