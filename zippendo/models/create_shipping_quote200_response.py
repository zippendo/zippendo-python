...
class CreateShippingQuote200Response(BaseModel):
    """
    CreateShippingQuote200Response
    """ # noqa: E501
    rates: List[CreateShippingQuote200ResponseRatesInner] = Field(description="Available shipping rates", json_schema_extra={"examples": [[]]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "rates": [CreateShippingQuote200ResponseRatesInner.from_dict(_item) for _item in obj["rates"]] if obj.get("rates") is not None else None
        })
        return _obj
