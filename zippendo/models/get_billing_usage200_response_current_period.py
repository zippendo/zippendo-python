...
class GetBillingUsage200ResponseCurrentPeriod(BaseModel):
    """
    GetBillingUsage200ResponseCurrentPeriod
    """ # noqa: E501
    start: StrictStr = Field(description="Start of the current usage period (ISO 8601)", json_schema_extra={"examples": ["2026-06-01T00:00:00.000Z"]})
    end: StrictStr = Field(description="End of the current usage period (ISO 8601)", json_schema_extra={"examples": ["2026-07-01T00:00:00.000Z"]})
