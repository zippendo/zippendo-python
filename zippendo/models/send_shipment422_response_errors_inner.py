...
class SendShipment422ResponseErrorsInner(BaseModel):
    """
    ...
    message: StrictStr = Field(description="Carrier-specific error message.", json_schema_extra={"examples": ["Receiver postal code is invalid for the selected product."]})
