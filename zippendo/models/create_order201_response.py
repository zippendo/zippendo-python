...
class CreateOrder201Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "orderNumber", "externalId", "customerName", "customerEmail", "shippingAddress", "orderLines", "subtotalAmount", "totalAmount", "currency", "status", "shippingRuleId", "notes", "externalData", "orderChannelId", "orgId", "createdAt", "updatedAt"]
