...
class CreateShippingQuote400Response(BaseModel):
    """
    CreateShippingQuote400Response
    """ # noqa: E501
    error: StrictStr = Field(description="Error type", json_schema_extra={"examples": ["Bad Request"]})
    message: StrictStr = Field(description="Human-readable error message", json_schema_extra={"examples": ["Invalid destination country"]})
