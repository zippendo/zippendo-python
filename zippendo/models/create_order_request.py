...
class CreateOrderRequest(BaseModel):
    ...
    CreateOrderRequest
    """ # noqa: E501
    order_number: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Human-readable order number.", alias="orderNumber", json_schema_extra={"examples": ["#1042"]})
    ...
    order_lines: Annotated[List[CreateOrderRequestOrderLinesInner], Field(min_length=1)] = Field(description="Line items in the order.", alias="orderLines")
