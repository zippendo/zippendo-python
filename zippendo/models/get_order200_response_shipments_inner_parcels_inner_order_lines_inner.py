...
class GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner(BaseModel):
    """
    GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner
    """ # noqa: E501
    id: StrictStr = Field(description="Parcel content line ID.", json_schema_extra={"examples": ["ol_9c1d2e3f"]})
    sku: Optional[StrictStr] = Field(default=None, description="SKU of the packed item.", json_schema_extra={"examples": ["SKU-1042-BLK"]})
    quantity: Annotated[int, Field(le=9007199254740991, strict=True, gt=0)] = Field(description="Quantity packed in this parcel.", json_schema_extra={"examples": [2]})
    description: Optional[StrictStr] = Field(default=None, description="Product description.", json_schema_extra={"examples": ["Wool Sweater"]})
    __properties: ClassVar[List[str]] = ["id", "sku", "quantity", "description"]
