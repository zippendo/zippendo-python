...
class SplitShipment201Response(BaseModel):
    """
    SplitShipment201Response
    """ # noqa: E501
    original_shipment: CreateShipment201Response = Field(alias="originalShipment")
    new_shipment: CreateShipment201Response = Field(alias="newShipment")
    __properties: ClassVar[List[str]] = ["originalShipment", "newShipment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of new_shipment
        if self.new_shipment:
            _dict['newShipment'] = self.new_shipment.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "newShipment": CreateShipment201Response.from_dict(obj["newShipment"]) if obj.get("newShipment") is not None else None
        })
        return _obj
