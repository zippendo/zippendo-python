...
class ListShippingRules200ResponseDataInnerLabelPrinter(BaseModel):
    """
    ListShippingRules200ResponseDataInnerLabelPrinter
    """ # noqa: E501
    id: StrictStr = Field(description="Printer ID", json_schema_extra={"examples": ["prn_01HZX9K2QF"]})
    name: StrictStr = Field(description="Printer name", json_schema_extra={"examples": ["Zebra ZD420 Lager"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListShippingRules200ResponseDataInnerLabelPrinter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListShippingRules200ResponseDataInnerLabelPrinter from a dict"""
        if obj is None:
            return None
