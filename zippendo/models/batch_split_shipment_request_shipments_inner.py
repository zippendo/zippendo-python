...
class BatchSplitShipmentRequestShipmentsInner(BaseModel):
    """
    BatchSplitShipmentRequestShipmentsInner
    """ # noqa: E501
    reference: Optional[StrictStr] = Field(default=None, description="Reference for this new shipment. Defaults to original reference with a suffix.", json_schema_extra={"examples": ["ORDER-1042-split-1"]})
    order_lines: Annotated[List[BatchSplitShipmentRequestShipmentsInnerOrderLinesInner], Field(min_length=1)] = Field(description="Order lines and quantities to move into this new shipment.", alias="orderLines")
    __properties: ClassVar[List[str]] = ["reference", "orderLines"]
