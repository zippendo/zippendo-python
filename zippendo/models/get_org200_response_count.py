...
class GetOrg200ResponseCount(BaseModel):
    """
    GetOrg200ResponseCount
    """ # noqa: E501
    members: Union[StrictFloat, StrictInt] = Field(description="Number of members in the organization", json_schema_extra={"examples": [8]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrg200ResponseCount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrg200ResponseCount from a dict"""
        if obj is None:
            return None
