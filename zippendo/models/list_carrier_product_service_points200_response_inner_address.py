...
class ListCarrierProductServicePoints200ResponseInnerAddress(BaseModel):
    """
    Postal address of the service point
    """ # noqa: E501
    address1: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Street address line 1", json_schema_extra={"examples": ["Vesterbrogade 1"]})
    address2: Optional[StrictStr] = Field(default=None, description="Street address line 2", json_schema_extra={"examples": ["2. sal"]})
    postal_code: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Postal code", alias="postalCode", json_schema_extra={"examples": ["1620"]})
    state: Optional[StrictStr] = Field(default=None, description="State or region")
    ...
    __properties: ClassVar[List[str]] = ["address1", "address2", "postalCode", "state", "city", "countryCode"]
