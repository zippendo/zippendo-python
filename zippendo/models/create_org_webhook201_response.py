...
class CreateOrgWebhook201Response(BaseModel):
    """
    ...
    secret: StrictStr = Field(description="Signing secret used to verify webhook payloads", json_schema_extra={"examples": ["whsec_8f3a1c2b9d4e5f6a"]})
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "url", "secret", "events", "isActive", "brandId", "createdAt", "updatedAt"]
