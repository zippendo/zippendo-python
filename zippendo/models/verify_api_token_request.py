...
class VerifyApiTokenRequest(BaseModel):
    """
    VerifyApiTokenRequest
    """ # noqa: E501
    token: StrictStr = Field(description="The API token to verify", json_schema_extra={"examples": ["zipp_live_8f3kd92ld0a7b6c5d4e3f2a1"]})
