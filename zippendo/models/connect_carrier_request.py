...
class ConnectCarrierRequest(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Carrier display name", json_schema_extra={"examples": ["PostNord"]})
    carrier_slug: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Carrier slug identifier", alias="carrierSlug", json_schema_extra={"examples": ["postnord"]})
