...
class GetOrder200ResponseShipmentsInnerParcelsInner(BaseModel):
    """
    GetOrder200ResponseShipmentsInnerParcelsInner
    """ # noqa: E501
    id: StrictStr = Field(description="Parcel ID.", json_schema_extra={"examples": ["prc_5a6b7c8d"]})
    weight: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Parcel weight in the given unit.", json_schema_extra={"examples": [2.5]})
    ...
    order_lines: List[GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner] = Field(description="Contents of this parcel.", alias="orderLines")
    __properties: ClassVar[List[str]] = ["id", "weight", "weightUnit", "dimensions", "orderLines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "orderLines": [GetOrder200ResponseShipmentsInnerParcelsInnerOrderLinesInner.from_dict(_item) for _item in obj["orderLines"]] if obj.get("orderLines") is not None else None
        })
        return _obj
