...
class BatchSendShipments200Response(BaseModel):
    """
    BatchSendShipments200Response
    """ # noqa: E501
    results: List[BatchSendShipments200ResponseResultsInner] = Field(description="Per-shipment outcome (one entry per unique requested shipment id).")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BatchSendShipments200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
            "summary": BatchSendShipments200ResponseSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
