...
class GetOrgBranding200Response(BaseModel):
    """
    GetOrgBranding200Response
    """ # noqa: E501
    primary_color: Optional[StrictStr] = Field(description="Primary brand color (hex)", alias="primaryColor", json_schema_extra={"examples": ["#1D4ED8"]})
    secondary_color: Optional[StrictStr] = Field(description="Secondary brand color (hex)", alias="secondaryColor", json_schema_extra={"examples": ["#F59E0B"]})
    logo_url: Optional[StrictStr] = Field(description="Authenticated URL to download the org logo image, or null if no logo is set", alias="logoUrl", json_schema_extra={"examples": ["/orgs/org_123/branding/logo"]})
    __properties: ClassVar[List[str]] = ["primaryColor", "secondaryColor", "logoUrl"]
