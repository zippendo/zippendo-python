...
class ListCarrierProducts200ResponseInnerServicesInner(BaseModel):
    """
    ListCarrierProducts200ResponseInnerServicesInner
    """ # noqa: E501
    name: StrictStr = Field(description="Display name of the additional service", json_schema_extra={"examples": ["Flex delivery"]})
    service_id: StrictStr = Field(description="Unique service identifier", alias="serviceId", json_schema_extra={"examples": ["A6"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListCarrierProducts200ResponseInnerServicesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListCarrierProducts200ResponseInnerServicesInner from a dict"""
        if obj is None:
            return None
