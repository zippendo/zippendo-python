...
class CreateShippingQuoteRequestDestination(BaseModel):
    """
    CreateShippingQuoteRequestDestination
    """ # noqa: E501
    country: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="ISO 3166-1 alpha-2 country code", json_schema_extra={"examples": ["DK"]})
    postal_code: Optional[StrictStr] = Field(default=None, description="Postal/ZIP code", alias="postalCode", json_schema_extra={"examples": ["1620"]})
    province: Optional[StrictStr] = Field(default=None, description="State/province code", json_schema_extra={"examples": [""]})
    city: Optional[StrictStr] = Field(default=None, description="City name", json_schema_extra={"examples": ["København"]})
    address1: Optional[StrictStr] = Field(default=None, description="Street address line 1", json_schema_extra={"examples": ["Vesterbrogade 1"]})
    address2: Optional[StrictStr] = Field(default=None, description="Street address line 2", json_schema_extra={"examples": ["2. sal"]})
    __properties: ClassVar[List[str]] = ["country", "postalCode", "province", "city", "address1", "address2"]
