...
class DeleteOrgWebhook200Response(BaseModel):
    """
    DeleteOrgWebhook200Response
    """ # noqa: E501
    message: StrictStr = Field(description="Result message", json_schema_extra={"examples": ["Webhook deleted successfully"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteOrgWebhook200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteOrgWebhook200Response from a dict"""
        if obj is None:
            return None
