...
class ListShippingRules200ResponseDataInnerAdditionalParametersInner(BaseModel):
    """
    ListShippingRules200ResponseDataInnerAdditionalParametersInner
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Carrier parameter key", json_schema_extra={"examples": ["returnFunctionality"]})
    val: StrictStr = Field(description="Parameter value (stringified)", json_schema_extra={"examples": ["LABELLESS"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListShippingRules200ResponseDataInnerAdditionalParametersInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListShippingRules200ResponseDataInnerAdditionalParametersInner from a dict"""
        if obj is None:
            return None
