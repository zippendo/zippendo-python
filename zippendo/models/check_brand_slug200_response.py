...
class CheckBrandSlug200Response(BaseModel):
    """
    CheckBrandSlug200Response
    """ # noqa: E501
    slug: StrictStr = Field(description="The slug that was checked", json_schema_extra={"examples": ["acme"]})
    available: StrictBool = Field(description="Whether the slug is free within this organization", json_schema_extra={"examples": [True]})
    __properties: ClassVar[List[str]] = ["slug", "available"]
