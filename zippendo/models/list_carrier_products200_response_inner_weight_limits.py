...
class ListCarrierProducts200ResponseInnerWeightLimits(BaseModel):
    """
    Allowed weight range for parcels using this product
    """ # noqa: E501
    min: Union[StrictFloat, StrictInt] = Field(description="Minimum allowed parcel weight", json_schema_extra={"examples": [0.1]})
    max: Union[StrictFloat, StrictInt] = Field(description="Maximum allowed parcel weight", json_schema_extra={"examples": [35]})
    unit: StrictStr = Field(description="Unit of the weight limits", json_schema_extra={"examples": ["kg"]})
    __properties: ClassVar[List[str]] = ["min", "max", "unit"]
