...
class ListAddresses200Response(BaseModel):
    ...
    """ # noqa: E501
    data: List[ListAddresses200ResponseDataInner] = Field(description="Page of results")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ListAddresses200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "limit": obj.get("limit"),
