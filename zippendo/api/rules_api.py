...
class RulesApi:
    ...
    def list_shipping_rules(
        ...
        carrier_id: Annotated[Optional[StrictStr], Field(description="Filter by carrier.")] = None,
        search: Annotated[Optional[StrictStr], Field(description="Search by rule name.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param carrier_id: Filter by carrier.
        :type carrier_id: str
        :param search: Search by rule name.
        :type search: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
