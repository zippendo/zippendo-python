...
from zippendo.configuration import Configuration
from zippendo.api_response import ApiResponse, T as ApiResponseT
import zippendo.models
from zippendo import rest
from zippendo.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(zippendo.models, klass)
