...
# **list_org_webhooks**
> ListOrgWebhooks200Response list_org_webhooks(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope, is_active=is_active, search=search)
...
with zippendo.ApiClient(configuration) as api_client:
    ...
    is_active = 'true' # str | Filter by active state. (optional)
    search = 'fulfilment' # str | Search by webhook name or URL. (optional)

    try:
        # List webhooks
        api_response = api_instance.list_org_webhooks(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope, is_active=is_active, search=search)
 ...
 **is_active** | **str**| Filter by active state. | [optional] 
 **search** | **str**| Search by webhook name or URL. | [optional] 
