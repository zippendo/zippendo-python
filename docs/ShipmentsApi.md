...
# **list_shipments**
> ListShipments200Response list_shipments(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope)
...
with zippendo.ApiClient(configuration) as api_client:
    ...
    try:
        # List shipments
        api_response = api_instance.list_shipments(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope)
