...
**description** | **str** | Internal label for this address; never printed or sent to a carrier | [optional] 
**att_contact** | **str** | Contact person at this address, printed as the att. line | [optional] 
