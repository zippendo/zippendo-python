...
# **list_carriers**
> ListCarriers200Response list_carriers(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope, carrier_slug=carrier_slug, search=search)
...
with zippendo.ApiClient(configuration) as api_client:
    ...
    carrier_slug = 'gls' # str | Filter by carrier slug. (optional)
    search = 'PostNord' # str | Search by carrier name. (optional)

    try:
        # List carriers
        api_response = api_instance.list_carriers(org_id, page=page, limit=limit, brand_id=brand_id, brand_scope=brand_scope, carrier_slug=carrier_slug, search=search)
 ...
 **carrier_slug** | **str**| Filter by carrier slug. | [optional] 
 **search** | **str**| Search by carrier name. | [optional] 
